...
cars.push({
  ...
  model: "Panda",
  color: "Grey",
  trims: ["city car", "basic", "easy park"],
...
const numberPos = function (charactersArray) {
  let positionsArray = [];
  for (let i = 0; i < charactersArray.length; i++) {
    switch (charactersArray[i].startsWith()) {
      case "a":
...
console.log(numberPos(charactersArray));
